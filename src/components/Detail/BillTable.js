...
const BillTable = () => {
  return (
    <TableContainer>
      <Row style={{background: '#CCD4E4', display:'flex', justifyContent: 'space-around', alignItems: 'center', fontSize: '18px', color: '#49446B', textAlign: 'center', padding: '3px 0'}}>
      ...
      <Row style={{border: 'solid 1px #C4C4D7', textAlign: 'center', fontSize: '16px', padding: '3px 0'}}>
